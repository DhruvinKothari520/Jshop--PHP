  ...
  <div class="header-right">
	...
	<?php
			if(isset($_POST["ok"]))
			{
					...
					$query = "insert into contact(fname,email,phone,message)
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			...
			<form class="contact100-form validate-form" name="f1" method="post">
				<div class="wrap-input100 validate-input" data-validate="Name is required">
					<span class="label-input100">Full Name:</span>
					<input class="input100" type="text" name="fname" placeholder="Enter full name">
				...
				<div class="container-contact100-form-btn">
					<button class="contact100-form-btn" name="ok">
						<span>
							Submit
